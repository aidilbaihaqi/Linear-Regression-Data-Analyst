...
def perform_regression(data):
    try:
        ...
        coef = model.params[1]  # Koefisien untuk X2
        pval = model.pvalues[1]  # P-value untuk X2
        signifikansi = "signifikan" if pval < 0.05 else "tidak signifikan"
        kesimpulan += f"Variabel X2 memiliki koefisien {coef:.2f} dan {signifikansi} dengan p-value {pval:.4f}.\n"
...
def main():
    ...
    # Membuat UI
    root = tk.Tk()
    root.title("Regresi Linear Variabel X2")
